  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center text-center text-white px-2 w-full h-full md:bg-transparent md:w-auto md:h-auto">
        ...
        <button  
          className="px-6 py-2 bg-[#6E71FC] text-white rounded-md hover:bg-[#6366ed] transition text-base font-bold shadow-md shadow-black flex items-center justify-center md:text-xl md:mt-4 md:w-auto md:max-w-none"
        >
